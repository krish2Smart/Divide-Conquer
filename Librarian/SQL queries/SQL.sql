...
insert into col_cd values('BE','AUTOMOBILE ENGINEERING','AUTOCD.pdf',12);
insert into col_cd values('BE','CIVIL ENGINEERING','CIVILCD.pdf',80);
insert into col_cd values('BE','COMPUTER SCIENCE ENGINEERING','CSECD.pdf',725);
insert into col_cd values('BE','INFORMATION TECHNOLOGY','ITCD.pdf',389);
insert into col_cd values('BE','ELECTRONICS & COMMUNICATION ENGINEERING','ECECD.pdf',180);
insert into col_cd values('BE','ELECTRICAL & ELECTRONICS ENGINEERING','EEECD.pdf',154);
insert into col_cd values('BE','ELECTRONICS & INSTRUMENTATION ENGINEERING','EIECD.pdf',33);
insert into col_cd values('BE','ELECTRONICS & TELECOMMUNICATION ENGINEERING','ETECD.pdf',87);
insert into col_cd values('BE','MECHANICAL ENGINEERING','MECHCD.pdf',242);
...
insert into jou_table values('BE','MECHANICAL ENGINEERING','Mech National List 11.08.2016.pdf',20,'MECHANICAL ENGINEERING INT JRLS.pdf',07);
insert into jou_table values('BE','ELECTRICAL & ELECTRONICS ENGINEERING','EEE NATIONAL JRLS (1).pdf',07,'ELECTRICAL INT JRLS.pdf',11);
insert into jou_table values('BE','ELECTRONICS & COMMUNICATION ENGINEERING','ECE NATIONAL JRLS (1)-2.pdf',09,'ELECTRONICS INT JRLS.pdf',13);
insert into jou_table values('BE','COMPUTER SCIENCE & ENGINEERING','CSE NATIONAL JRLS.pdf',17,'COMPUTER SCIENCE INT JRLS.pdf',14);
insert into jou_table values('BE','INFORMATION TECHNOLOGY','ITNATIONAL JRLS.pdf',13,'INFORMATION TECHNOLOGY INT JRLS.pdf',15);
insert into jou_table values('BE','CIVIL ENGINEERING','CIVIL NATIONAL JRLS (2).pdf',19,'CIVIL  ENGINEERING INT JRLS.pdf',07);
insert into jou_table values('BE','ELECTRONICS & INSTRUMENTATION ENGINEERING','EIENATIONAL JRLS.pdf',07,'ELECTRONICS INT JRLS.pdf',11);
insert into jou_table values('BE','AUTOMOBILE ENGINEERING','AUTOMOBILENATIONAL JRLS.pdf',08,'AUTOMOBILE  ENGINEERING INT JRLS.pdf',06);
insert into jou_table values('BE','ELECTRONICS & TELECOMMUNICATION ENGINEERING','ETE NATIONAL JRLS.pdf',07,'ELECTRONICS TELE INT JRLS.pdf',07);
insert into jou_table values('ME','MECHATRONICS (M.E)','M E MECHAT NATIONAL JRLS.pdf',05,'ME  MECHATRONICS INT JRLS.pdf',05);
insert into jou_table values('ME','COMMUNICATION SYSTEM (M.E)','M E COMM. SYS NATIONAL JRLS.pdf',05,'ME  COMMUNICATION SYSTEMS INT JRLS.pdf',05);
insert into jou_table values('ME','V.L.S.I (M.E)','M E VLSI NATIONAL JRLS.pdf',05,'ME  VLSI INT JRLS.pdf',05);
...
insert into mag_table values('BE','MECHANICAL ENGINEERING','MECH NATIONAL MAGAZINES.pdf',17,'',0);
insert into mag_table values('BE','ELECTRICAL & ELECTRONICS ENGINEERING','EEE NATIONAL MAGAZINES.pdf',08,'INTERNATIONAL MAGAZINES EEE.pdf',03);
insert into mag_table values('BE','ELECTRONICS & COMMUNICATION ENGINEERING','ECE NATIONAL MAGAZINES.pdf',04,'INTERNATIONAL MAGAZINES ECE.pdf',05);
insert into mag_table values('BE','COMPUTER SCIENCE & ENGINEERING','CSE NATIONAL MAGAZINES.pdf',05,'INTERNATIONAL MAGAZINES CSE.pdf',05);
insert into mag_table values('BE','INFORMATION TECHNOLOGY','IT NATIONAL MAGAZINES.pdf',05,'INTERNATIONAL MAGAZINES IT.pdf',02);
insert into mag_table values('BE','CIVIL ENGINEERING','CIVIL NATIONAL MAGAZINES.pdf',19,'INTERNATIONAL MAGAZINES CIVIL-2.pdf',01);
insert into mag_table values('BE','ELECTRONICS & INSTRUMENTATION ENGINEERING','EIE NATIONAL MAGAZINES.pdf',05,'',0);
insert into mag_table values('BE','AUTOMOBILE ENGINEERING','AUTO NATIONAL MAGAZINES.pdf',15,'INTERNATIONAL MAGAZINES AUTO.pdf',01);
insert into mag_table values('BE','ELECTRONICS & TELECOMMUNICATION ENGINEERING','ETE NATIONAL MAGAZINES.pdf',04,'',0);
...
create table downloads(staff_name varchar(130),department varchar(50),paper varchar(256),journal_name varchar(120),file_name varchar(200));
insert into downloads values('B.Subramanian','Library','Information Seeking Behaviour of Faculty Members of Karpagam University in Coimbatore, India','Library Progress','Final-13-P-135-143-INFORMATION SEEKING BEHAVIOUR OF FACULTY MEMBERS OF KARPAGAM UNIVERSITY IN COIMBATORE, INDI-1.pdf');
insert into downloads values('B.Subramanian','Library','Information needs and Information seeking behaviour of Students in Karpagam University: A Survey','Library Progress','PDF-5-P-181-187-INFORMATION NEEDS AND INFORMATION SEEKING BEHAVIOUR OF STUDENTS IN KARPAGAM UNIVERSITY A SURVEY.pdf');
insert into downloads values('B.Subramanian','Library','A Bibliometric Study of Publications by Annals of Library Information Studies 1997 - 2011','International Journal of Librarianship and Administration','IJLA-paper 2.pdf');
insert into downloads values('B.Subramanian','Library','Information Seeking Behaviour and Library use pattern of biotechnology researchers in the Bharathidasan University in Tamilnadu','Global Research Analysis','file.pdf');
insert into downloads values('B.Subramanian','Library','Research Scholar''s Information Seeking Behaviour in Bharathidasan University, Thiruchirappalli, India - A Study ','International Journal of Research in Social Sciences (e-journal)','IJMRA-9914-1.pdf');
