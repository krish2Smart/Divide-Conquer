					...
					for(i = 0; i < roomDatas.length; i++) {
						if(roomDatas[i].id == occupancyID) {
							...
							if(roomDatas[i].dryCleaning === true)
								...
								temp = "no";
							HTMLContent += "<li><p id=\"display-dry-cleaning\">Dry Cleaning : "+temp+"</p></li>";								
							if(roomDatas[i].laundryFacilities === true)
								temp = "yes";
							else 
								temp = "no";
							HTMLContent += "<li><p id=\"display-laundry-facilities\">Laundry Facilities : "+temp+"</p></li>";
							if(roomDatas[i].freeNewspapers === true)
								temp = "yes";
							else 
								temp = "no";
							HTMLContent += "<li><p id=\"display-free-newspapers\">Free Newspapers : "+temp+"</p></li>";
