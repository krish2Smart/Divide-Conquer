...
/**
 * Servlet implementation class FreeENews
 */
@WebServlet("/FreeENews")
public class FreeENews extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet setContent = stmnt.executeQuery("select * from free_newspapers;");
